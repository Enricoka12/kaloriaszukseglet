...
<div className="text-center m-5 flex justify-center">
  ...
  <button onClick={() => {
            props.elorevaltas();
            props.setsuly(suly); // A kor állapot átadása az Adatbekeres szülő komponensnek
